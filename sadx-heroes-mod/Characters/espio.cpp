...
CollisionData Ninja_Col = { 0, CI_FORM_SPHERE, CI_PUSH_TH_ALL, CI_DMG_SET(3, 3) | CI_DMG_ENEMY, CI_ATTR_DAMAGE, { 0.0f, 0.0f, 0.0f }, 8.0f, 0.0f, 0.0f };
...
void EspioHeroes_Main(ObjectMaster *obj) {
	...
	case 2:
		...
		SonicAnimConverter(&pwp_heroes->mm, HeroesChars_Espio, (taskwk*)playerdata, (playerwk*)playerco2);
