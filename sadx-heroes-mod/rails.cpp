...
EntityData1* RailPath_LoadRail(EntityData1* PlayerEntity, LoopHead* loophead, uint16_t point, float state) {
	...
	PlayCustomSound_EntityAndPos(CommonSound_RailHit, exec, &PlayerEntity->Position, 500, 2, false);
	PlayCustomSound_EntityAndPos(CommonSound_Rail, exec, &PlayerEntity->Position, 500, 2, true);
